...
- [ ] Shared libraries foundation: venueintelligence-process and venueintelligence-model with domain contracts · Epic: E1-master-venue-catalog · Milestone: v0.1-mvp · Priority: P0

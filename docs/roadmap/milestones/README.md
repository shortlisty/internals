...
| -------------------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Database decomposition     | v1.2+            | Split shared PostgreSQL into catalog_db and pitch_db when read/write patterns diverge or operational pressure demands it. See [D19](../decisions/D19-shared-database-per-product.md). | v1.0 `Completed`; operational signal (query contention or schema coupling cost) must justify the split |

...
- `venueintelligence-process` - Domain-agnostic extraction and metadata infrastructure
- `venueintelligence-model` - Venue-specific domain models, migrations, and contracts

...
| Planning Pod sync (BEO seed + floor-plan bi-sync) | D (Post-v1.0)  | Tier-3 integration: pull questionnaires/briefs/budgets; push approved venue as BEO seed, budget line items; bi-directional PDF floor-plan asset sync between VenueMi catalog and Planning Pod layout tool.                                                              | E9 promoted, Tier-2 at In progress                   |

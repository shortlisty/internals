...
> **Purpose:** Strategic reference for the competitive positioning of StashRoom across the event tool ecosystem. Used as context for the more focused DSR competitive analysis in [Digital_Sales_Room_for_Events/comparison.md](../../Digital_Sales_Room_for_Events/comparison.md).

---

## Quick Reference — All Covered Tools

### Venue & Event Management

| Tool                  | Website                                          |
| --------------------- | ------------------------------------------------ |
| Cvent                 | [cvent.com](https://www.cvent.com)               |
| Tripleseat            | [tripleseat.com](https://tripleseat.com)         |
| Momentus Technologies | [gomomentus.com](https://gomomentus.com)         |
| Facilitron            | [facilitron.com](https://www.facilitron.com)     |
| Propared              | [propared.com](https://www.propared.com)         |
| Planning Pod          | [planningpod.com](https://planningpod.com)       |
| iVvy                  | [ivvy.com](https://www.ivvy.com)                 |
| BookVenue.ai          | [bookvenue.ai](https://bookvenue.ai)             |
| Perfect Venue         | [perfectvenue.com](https://www.perfectvenue.com) |
| Event Temple          | [eventtemple.com](https://eventtemple.com)       |
| VenueArc              | [venuearc.com](https://www.venuearc.com)         |

### Venue Discovery & Sourcing

| Tool                 | Website                                                                                | Strength                                                                                                                          | Overlap with StashRoom                                                                                                |
| -------------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
...
| VenueFindAI          | [venuefindai.com](https://venuefindai.com)                                             | AI + human concierge, free for planners                                                                                           | Discovery-only; recommendations are ephemeral, no stored portfolio                                                    |
| Ventur3              | [ventur3.com](https://www.ventur3.com)                                                 | Structured RFP builder, real-time response tracking, free tier                                                                    | RFP workflow only; data comes from venues, not from planner's own documents                                           |
| Planner Hero         | [plannerhero.com](https://www.plannerhero.com)                                         | 25 years of expertise, human team + sourcing dashboard, contract negotiation                                                      | Agency model: intelligence stays with the agency, not in the client's system                                          |
| Hopskip              | [myhopskip.com](https://myhopskip.com)                                                 | 150K+ hotels/venues, 87% RFP response rate, structured side-by-side proposals, free to start                                      | Hotel/venue RFP sourcing; no persistent venue portfolio on the planner's side                                         |
| Planned              | [planned.com](https://planned.com)                                                     | AI agent executes the full sourcing cycle (quotes → negotiation → contract), human experts in loop, enterprise policy enforcement | AI operating system for sourcing; no knowledge base built from planner's own documents                                |
| Tagvenue             | [tagvenue.com](https://www.tagvenue.com)                                               | 80K+ venues, fully self-service, free for planners, transparent pricing, global reach                                             | Self-serve marketplace; discovery only, no planner-side library                                                       |
| Stova                | [stova.io](https://stova.io)                                                           | Enterprise eRFP + full event management suite, strategic meetings management, real-time sourcing analytics                        | Venue sourcing as part of a large enterprise platform; no document intelligence                                       |
| The Vendry           | [thevendry.com](https://www.thevendry.com)                                             | 1M+ venue/vendor data points, community of 25K+ corporate planners, Teams tier for saving and sharing                             | Closest to a portfolio concept (save/share venues); data comes from the marketplace, not from planner's own documents |
| FCM Venue Finder     | [fcmvenuefinder.com](https://www.fcmvenuefinder.com)                                   | 200K+ meeting spaces, integrated into FCM travel management, sustainability data, cost control                                    | Venue sourcing embedded in a travel management programme; no document intelligence                                    |
| Navan Events         | [navan.com/product/meetings-and-events](https://navan.com/product/meetings-and-events) | AI Event Agent (launched June 2026), sourcing + attendee travel + reporting in one platform, NASDAQ-listed                        | Unified corporate events platform; venue sourcing as part of travel stack, no planner-owned knowledge base            |
| Eventful             | [eventful.co.uk](https://www.eventful.co.uk)                                           | UK-based consultancy + venue sourcing, bespoke approach, embeds into client team                                                  | Agency model: expertise lives with the team, not in the client's system                                               |
| Hire Space           | [hirespace.com](https://hirespace.com)                                                 | AI-powered shortlisting, 10-year proprietary UK venue pricing dataset, Hire Space 360 full-service layer, £3bn+ events processed  | UK-focused discovery + expert concierge; no planner-side document intelligence or owned knowledge base                |
| Groups360            | [groups360.com](https://groups360.com)                                                 | 200K+ hotels, instant booking for smaller groups, structured RFP for larger, real-time rate and availability data                 | Hotel/group travel RFP sourcing; no persistent venue portfolio or document intelligence on planner's side             |
| Peerspace            | [peerspace.com](https://www.peerspace.com)                                             | Largest hourly venue rental marketplace, unique/creative spaces, $40–260/hr, global reach                                         | Self-serve peer-to-peer marketplace; discovery only, no planner-side library or document intelligence                 |
| Splacer              | [splacer.co](https://www.splacer.co)                                                   | Curated creative and unique spaces (homes, galleries, lofts), local scouts vet listings, $35M+ raised                             | Discovery marketplace for non-traditional spaces; no planner knowledge base                                           |
| Giggster             | [giggster.com](https://giggster.com)                                                   | Film/photo production + event spaces, permit assistance, insurance required, US/UK focus                                          | Production-oriented venue discovery; no planner-side portfolio management                                             |

### Digital Asset Management (DAM)

| Tool        | Website                                    |
| ----------- | ------------------------------------------ |
| Bynder      | [bynder.com](https://www.bynder.com)       |
| Brandfolder | [brandfolder.com](https://brandfolder.com) |

### AI Productivity for Event Professionals

| Tool                  | Website                          |
| --------------------- | -------------------------------- |
| Spark by GEVME & PCMA | [sparkit.ai](https://sparkit.ai) |

### DIY Venue Management Stack

| Tool            | Website                                                                                            |
| --------------- | -------------------------------------------------------------------------------------------------- |
| Google Drive    | [drive.google.com](https://drive.google.com)                                                       |
| Dropbox         | [dropbox.com](https://www.dropbox.com)                                                             |
| SharePoint      | [microsoft.com/sharepoint](https://www.microsoft.com/en-us/microsoft-365/sharepoint/collaboration) |
...
| Microsoft Excel | [microsoft.com/excel](https://www.microsoft.com/en-us/microsoft-365/excel)                         |
| Gmail           | [gmail.com](https://mail.google.com)                                                               |
| Outlook         | [outlook.com](https://outlook.com)                                                                 |
| ChatGPT         | [chatgpt.com](https://chatgpt.com)                                                                 |
| Claude          | [claude.ai](https://claude.ai)                                                                     |

### Document Intelligence & ETL

| Tool            | Website                                                      |
| --------------- | ------------------------------------------------------------ |
| Unstructured.io | [unstructured.io](https://unstructured.io)                   |
| IBM Docling     | [github.com/DS4SD/docling](https://github.com/DS4SD/docling) |
| Apache Tika     | [tika.apache.org](https://tika.apache.org)                   |
...
| Raydocs         | [raydocs.ai](https://raydocs.ai)                             |
| Retab           | [retab.ai](https://retab.ai)                                 |

### Floor Plan Intelligence & Spatial Data

| Tool                | Website                                                |
| ------------------- | ------------------------------------------------------ |
| SeatPlan.io         | [seatplan.io](https://seatplan.io)                     |
| FloorScan.ai        | [floorscan.ai](https://floorscan.ai)                   |
| FloorPlan API       | [floorplanapi.com](https://floorplanapi.com)           |
| Open Location Stack | [openlocationstack.com](https://openlocationstack.com) |
...
**Gaps relevant to StashRoom Intelligence:**
...
**Verdict:** Not a direct competitor. Cvent is a venue marketplace. StashRoom Intelligence is an intelligence layer for your own venue portfolio. They could be _complementary_ (import discovered venues from Cvent into StashRoom).
...
**Verdict:** Different side of the market. Tripleseat serves venues; StashRoom serves planners. The intelligence architectures are fundamentally different: Tripleseat mines structured operational data; StashRoom mines unstructured documents.
...
**Verdict:** Enterprise venue ops software. No overlap with StashRoom's document intelligence core.
...
**Verdict:** Facilitron is a public-sector facility operations and community rental platform. It serves the venue operator side — helping schools and cities manage their own spaces and earn rental revenue from the community. It has no overlap with StashRoom's core use case. A school district using Facilitron to manage gym rentals is not an StashRoom customer; an event agency trying to find and brief that school's gym is.
...
**Verdict:** Propared is production operations software for the teams _producing_ an event — stage managers, production managers, technical directors. StashRoom Intelligence is knowledge management software for event managers _finding and briefing_ venues. The workflows are adjacent but the users and the data are entirely different. A production manager at a theatre company uses Propared to schedule the load-in; the event agency that booked that theatre used StashRoom to find it.
...
**Verdict:** Irrelevant to StashRoom's positioning. Different price/feature tier entirely. Planning Pod (see above) is the more capable tool in this tier and has its own entry.

---

#### Ventur3

**What it is:** SaaS venue sourcing and RFP platform positioning itself as a smarter Cvent alternative for mid-market and SMB event planners. Core workflow: build a custom RFP using a guided process, distribute it to venues, track responses in real time, and compare results. Free plan allows RFPs to up to 10 properties. Paid tiers scale RFP distribution, user count, and access to verified property contacts. Targets individual planners through to enterprise teams.

**Strengths:**

- Guided RFP builder — structured process captures event requirements and matches to venue needs, reducing back-and-forth with properties
- Real-time RFP tracking dashboard — visibility into every step of the process without chasing venues by email
- Smart filters and interactive venue maps for initial discovery
- In-depth venue profiles for comparison before sending an RFP
- Scalable tiers: free entry for occasional planners; Professional/Enterprise for teams managing multiple concurrent events
- Customisable RFP questions — higher tiers allow unlimited question customisation
...
- Venue data comes from venue self-submission and RFP responses — not from the planner's own files
- No persistent venue portfolio: when an event closes, the intelligence from that RFP doesn't accumulate into a searchable team library
- No document intelligence, no floor plan parsing, no spec sheet extraction
- No multi-source aggregation or conflict resolution

**Verdict:** Same sourcing/discovery quadrant as Cvent and VenueScanner, but lighter-weight and SMB-accessible. Ventur3 helps planners find and brief venues they haven't worked with — StashRoom manages the portfolio of venues they already know and trust. Complementary: a planner discovers a venue through Ventur3's RFP process, then ingests that venue's response documents into StashRoom to build a permanent, searchable profile.

---

#### Planner Hero

**What it is:** A hybrid: primarily a full-service event management and site sourcing agency (25 years in business, human specialist team), with a proprietary site sourcing software product available to clients. The agency handles incentive trips and corporate events end-to-end — from venue sourcing through on-site execution. The software layer provides a sourcing dashboard with "hotel intel" and "comprehensive dashboard views" that planners describe as a tool they keep in their arsenal. 1,000+ events sourced; 250+ years of combined team experience.

**Model:** Services-first, software-supported. Unlike pure SaaS platforms (Cvent, Ventur3, VenueScanner), Planner Hero's primary value proposition is the human expertise — the software augments the team's sourcing capability rather than replacing the human layer.

**Strengths:**

- Deep hospitality domain expertise baked into the sourcing process — not just a venue database but a team that knows which venues negotiate well, which have hidden limitations, and which match specific client cultures
- Contract negotiation and on-site support included — goes beyond sourcing into full event execution
- Software dashboard provides "hotel intel" and visibility that clients describe as a competitive advantage
...
- Software dashboard appears to support the agency's sourcing workflow, not to give clients a self-serve venue portfolio they own and search independently
...
**Verdict:** VenueScanner is a consumer-grade venue search engine, not a planner intelligence tool. A planner who already knows their preferred venues gets nothing from VenueScanner — it only helps with first-pass discovery of venues they haven't worked with yet. Complementary to StashRoom, not competitive.
...
**Verdict:** Same quadrant as VenueScanner and Cvent — a venue marketplace/sourcing tool for _discovering_ new venues. StashRoom solves the adjacent and complementary problem: once you've found and worked with venues, how do you manage, extract intelligence from, and search across everything you already know about them. A planner could use VenueFindAI to discover a venue, then use StashRoom to ingest that venue's documents and build a permanent, searchable profile.
...
**Verdict:** Niche venue operations software for a specific vertical (performing arts). No overlap with StashRoom's core use case. Closer to a lighter-weight Momentus than anything in StashRoom's competitive set.
...
**Verdict:** Spark is the closest thing to a purpose-built AI assistant for event planners, and it's well-adopted (14,500+ users). But it's a _writing and workflow_ tool, not a _knowledge_ tool. A planner using Spark can draft an RFP faster — but still has no structured, searchable record of what their 50 preferred venues actually offer. StashRoom and Spark are complementary: Spark generates the content; StashRoom supplies the venue intelligence that makes that content accurate and specific.

---

### 1.4 DIY Venue Management Stack

The most common "competitor" isn't a product — it's a patchwork of 5–7 general-purpose tools that planners assemble themselves because no purpose-built alternative existed. Understanding this stack is critical: StashRoom's real displacement target is not Cvent or Bynder but the Google Drive folder, the Airtable base, and the Notion page that a planner has been maintaining by hand for three years.

---

#### Google Drive / Dropbox / SharePoint

**What it is:** Cloud file storage that every planning team already uses. PDF venue decks, floor plans, photos, spec sheets, and contract drafts all live here — usually in ad-hoc folder structures that make sense to whoever created them.

**Why planners use it:** Zero adoption friction. Files land here automatically (email attachments saved, venue portals downloaded, post-visit uploads). Free or already licensed through the company's G Suite / Microsoft 365 subscription.

**Why it fails as a venue intelligence tool:**

- Files are stored but not read — "search" returns file names, not facts inside files
- Folder structure is personal and non-transferable — a leaving planner takes their organisational logic with them
- No structured schema: a PDF and a floor plan sit next to each other with no relationship, no extracted fields, no queryable metadata
...
**The StashRoom displacement:** Google Drive is where files live. StashRoom is where venue knowledge lives. StashRoom does not replace Drive — it reads the files in Drive and makes their contents searchable.

---

#### Notion

**What it is:** Flexible all-in-one workspace used by planners to build manual venue databases, post-visit notes, client briefs, and team wikis. A typical Notion venue database has columns for capacity, catering notes, contact names, and a link to the Drive folder — all entered by hand.

**Why planners use it:** Highly customisable, good enough for small portfolios, free tier is generous. Feels like building a real database without needing engineering help.

**Why it fails as a venue intelligence tool:**

- Every row is manually entered — data goes stale the moment a venue updates its spec sheet
- No document parsing: a PDF attached to a Notion page is a link, not extracted structured data
- Search is keyword-based across manually entered text — not semantic search across extracted venue attributes
- No multi-source aggregation: if a venue sends an updated deck, someone has to manually reconcile the changes
...
**The StashRoom displacement:** Notion is what planners build when they want structure but can't afford the time to maintain it. StashRoom fills the same structural role — venue profiles with fields — but populated automatically from source documents rather than by hand.

---

#### Airtable

**What it is:** Spreadsheet-database hybrid used by more technical planners to build structured venue libraries. Typically has fields for venue name, location, capacity configurations, catering restrictions, AV specs, pricing tier, contact details, and a file attachment column for the venue deck.

**Why planners use it:** More powerful than a spreadsheet, more structured than Notion. Can filter, sort, group, and build views. Feels like a real product database.

**Why it fails as a venue intelligence tool:**

- Same fundamental problem as Notion: manually entered data that goes stale
- File attachments are links — Airtable does not read the attached PDFs
- Formula and filter logic breaks when venue data is missing or inconsistently formatted
- No semantic search — "find me a venue with a freight lift and kosher catering" requires pre-built views or manual filtering across fields someone remembered to fill in
...
**The StashRoom displacement:** Airtable is the most sophisticated DIY alternative. Planners who use Airtable understand the value of structured venue data — they just shouldn't have to maintain the structure themselves. StashRoom is Airtable for venue intelligence, with the data entry handled by AI.

---

#### Excel / Google Sheets

**What it is:** The universal fallback. Every planner has a venue spreadsheet. Some are simple (name, capacity, contact); some are elaborate multi-tab workbooks with conditional formatting and VLOOKUP chains that only one person understands.

**Why planners use it:** Already open, no new tool to learn, shareable with anyone.

**Why it fails as a venue intelligence tool:**

- No file parsing, no document intelligence, no AI of any kind
- Data is only as good as the last manual update
- Search is Ctrl+F — no semantic matching, no fuzzy search, no natural language
...
**The StashRoom displacement:** The spreadsheet is the symptom StashRoom is treating. "Every planner has one. Nobody trusts it." — already in the homepage copy for good reason.

---

#### Gmail / Outlook (email as a venue database)

**What it is:** In practice, the most complete record of a planner's venue intelligence — emails from venue coordinators, PDF attachments, follow-up threads with updated specs, pricing discussions. Everything the planner actually knows about a venue is somewhere in their inbox.

**Why planners use it:** It's not a choice — it's where the documents arrive. The inbox is the unavoidable input channel for venue information.

**Why it fails as a venue intelligence tool:**

- Non-transferable: the inbox belongs to the individual, not the team
- Search requires knowing what you're looking for — no way to query "which venues I've emailed allow external catering"
...
**The StashRoom displacement:** StashRoom is the extraction layer that should sit between "venue sends a PDF by email" and "team can search that PDF's contents." The inbox is the source; StashRoom is the destination.

---

#### ChatGPT / Claude (ad-hoc document Q&A)

**What it is:** Increasingly, planners paste venue PDFs into ChatGPT or Claude and ask questions: "What's the standing capacity?", "Does this venue allow external catering?", "Summarise the AV specs." It works for a single document in a single session.

**Why planners use it:** Immediate, zero friction, good enough for one-off answers. Faster than reading a 50-page deck.

**Why it fails as a venue intelligence tool:**

- No memory across sessions — tomorrow's query has no context from today's
- No team sharing — the answer exists only in one person's browser tab
- No structured schema — the output is generated prose, not queryable structured fields
...
**The StashRoom displacement:** ChatGPT answers a question about one document right now. StashRoom remembers every document ever uploaded, extracts structured data the whole team can search, and flags when two documents about the same venue disagree. The difference between a conversation and a knowledge base.

---

### 1.5 Document Intelligence & ETL Platforms

These are the infrastructure players. They are the technical substrate that StashRoom's pipeline either competes with or can leverage.
...
**Relevance to StashRoom Intelligence:**

- Unstructured.io is what StashRoom's ETL layer _could use as a backend_ rather than building from scratch
...
**Strategic insight:** StashRoom doesn't need to reinvent document parsing. Unstructured.io (or Docling) handles the extraction layer. StashRoom's value add is the _venue-specific intelligence_ on top — the domain schema, the aggregation model, the search experience, the team collaboration.
...
**Why it matters for StashRoom Intelligence:**
...
**Strategic decision for StashRoom Intelligence:** Use Docling as the primary document parsing layer. It handles the structural extraction (layout, tables, text) and Spring AI's ETL pipeline then handles chunking, embedding, and vector storage.
...
**Why it's the right choice for StashRoom Intelligence:**
...
**Relevance to StashRoom Intelligence:** These are Python-ecosystem tools. Since StashRoom Intelligence is Java/Spring Boot, they are not directly applicable. Spring AI is the Java equivalent and has caught up rapidly.

**Note:** If StashRoom ever needs a Python microservice for specialized extraction (e.g., advanced floor plan analysis), LlamaIndex's LlamaParse is best-in-class for complex PDFs.
...
**Pattern:** All these companies are _horizontal_ document intelligence APIs. StashRoom's opportunity is to be _vertical_ — deeply specialized for venue documents (floor plans, venue decks, CAD files, spec sheets). Horizontal tools extract generic fields. StashRoom extracts venue-specific intelligence with a purpose-built schema.

---

### 1.6 Floor Plan Intelligence & Spatial Data Tools

A distinct cluster of tools that deal with floor plan geometry, spatial extraction, or indoor location infrastructure. None of them are venue management or event planning platforms, but they are directly adjacent to StashRoom's document intelligence layer — specifically the CAD/floor plan ingestion pipeline. Understanding where they sit clarifies what StashRoom needs to build versus what it can leverage or ignore.
...
**Verdict:** SeatPlan.io solves the downstream problem — arranging guests in a space the planner has already chosen. StashRoom solves the upstream problem — knowing and comparing the spaces themselves. The AI floor plan import is the only genuine overlap: both tools ingest floor plan PDFs. But SeatPlan produces a seating layout; StashRoom extracts structured venue intelligence. Complementary: a planner uses StashRoom to decide which room to book, then SeatPlan.io to seat the guests.
...
**Verdict:** FloorScan.ai is a construction industry tool whose core capability — AI geometry extraction from PDF floor plans — is the same technical problem StashRoom faces for venue CAD files. It's not a competitor but a technical reference point: the accuracy benchmark (sub-30s analysis, confidence-scored element detection, DXF export) is the quality bar StashRoom's floor plan parsing pipeline should target. StashRoom's differentiation is what happens _after_ geometric extraction: mapping room dimensions to event configurations, seating capacities, and a searchable venue intelligence schema.
...
- FloorPlan API is a potential _infrastructure component_ for StashRoom's floor plan pipeline — the same role Apache Tika plays for text extraction
...
**Strategic decision for StashRoom Intelligence:** FloorPlan API (or an equivalent: CubiCasa, Archilogic, or an in-house Docling-based pipeline) handles geometric extraction from raster floor plans. StashRoom's proprietary layer is the venue intelligence schema mapped _onto_ that geometry — room identifiers, configuration capacities, sightlines, access points — none of which FloorPlan API provides.

**Verdict:** Not a competitor. A candidate infrastructure vendor for the geometric extraction step of StashRoom's CAD/floor plan ingestion pipeline.
...
**Why it appears here:** The IMDF structured indoor map format is relevant to StashRoom's long-term architecture. IMDF is the OGC standard for portable venue maps — georeferenced vector geometry with named rooms, levels, and zones. If StashRoom ever moves beyond document extraction into interactive floor plan rendering (Phase 3+), IMDF is the output format to target. Open Location Stack's Floor Plan Editor demonstrates what a browser-based IMDF authoring tool looks like.

**Verdict:** No competitive overlap. Open Location Stack targets logistics and manufacturing RTLS deployments. StashRoom targets event planning knowledge management. The IMDF format is worth monitoring as a potential output standard for StashRoom's structured venue map layer.

---

### 1.7 Competitive Gap Summary

| Capability                               | Cvent            | Tripleseat      | Momentus        | Facilitron         | Propared         | Planning Pod    | VenueScanner    | VenueFindAI     | Ventur3             | Planner Hero         | VenueArc        | Spark (GEVME/PCMA)    | Bynder            | Brandfolder         | Unstructured.io | G Drive / Dropbox | Notion / Airtable | Spreadsheets | Email (inbox) | ChatGPT / Claude    | SeatPlan.io           | FloorScan.ai      | FloorPlan API      | Open Location Stack | StashRoom           |
| ---------------------------------------- | ---------------- | --------------- | --------------- | ------------------ | ---------------- | --------------- | --------------- | --------------- | ------------------- | -------------------- | --------------- | --------------------- | ----------------- | ------------------- | --------------- | ----------------- | ----------------- | ------------ | ------------- | ------------------- | --------------------- | ----------------- | ------------------ | ------------------- | ------------------- |
...
| Document / asset storage                 | ⛔               | ⛔              | ⛔              | ⛔                 | ⛔               | ⛔              | ⛔              | ⛔              | ⛔                  | ⛔                   | ⛔              | ⛔                    | ✅ (brand assets) | ✅ (brand assets)   | ✅ (infra only) | ✅ (files only)   | Partial (links)   | ⛔           | ✅ (inbox)    | ⛔                  | ⛔                    | ⛔                | ⛔                 | ⛔                  | ✅                  |
| Document intelligence (PDF, floor plans) | ⛔               | ⛔              | ⛔              | ⛔                 | ⛔               | ⛔              | ⛔              | ⛔              | ⛔                  | ⛔                   | ⛔              | ⛔                    | ⛔                | ⛔                  | ✅ (infra only) | ⛔                | ⛔                | ⛔           | ⛔            | Partial (one-off)   | Partial (layout only) | ✅ (construction) | ✅ (geometry only) | ⛔                  | ✅                  |
| AI metadata extraction                   | ⛔               | ⛔              | ⛔              | ⛔                 | ⛔               | ⛔              | ⛔              | ⛔              | ⛔                  | ⛔                   | ⛔              | ✅ (generated text)   | ✅ (generic)      | ✅ (generic)        | ✅ (generic)    | ⛔                | ⛔                | ⛔           | ⛔            | Partial (no memory) | ✅ (seating layout)   | ✅ (quantities)   | ✅ (geometry)      | ⛔                  | ✅ (venue-specific) |
...
| Event planning workflow / content gen    | ⛔               | ⛔              | ⛔              | ⛔                 | ⛔               | ⛔              | ⛔              | ⛔              | ⛔                  | ✅ (managed service) | ⛔              | ✅ Best-in-class      | ⛔                | ⛔                  | ⛔              | ⛔                | ⛔                | ⛔           | ⛔            | Partial (one-off)   | ✅ (seating/check-in) | ⛔                | ⛔                 | ⛔                  | ⛔                  |
| Production planning (crew, schedule)     | ⛔               | ⛔              | ⛔              | ⛔                 | ✅ Best-in-class | ⛔              | ⛔              | ⛔              | ⛔                  | ⛔                   | ⛔              | ⛔                    | ⛔                | ⛔                  | ⛔              | ⛔                | ⛔                | ⛔           | ⛔            | ⛔                  | ⛔                    | ⛔                | ⛔                 | ⛔                  | ⛔                  |
| Semantic search (vector)                 | ⛔               | ⛔              | ⛔              | ⛔                 | ⛔               | ⛔              | ⛔              | ⛔              | ⛔                  | ⛔                   | ⛔              | ⛔                    | ⛔                | Partial (NL search) | ⛔              | ⛔                | ⛔                | ⛔           | ⛔            | Partial (no memory) | ⛔                    | ⛔                | ⛔                 | ⛔                  | ✅                  |
| Real-time location / RTLS                | ⛔               | ⛔              | ⛔              | ⛔                 | ⛔               | ⛔              | ⛔              | ⛔              | ⛔                  | ⛔                   | ⛔              | ⛔                    | ⛔                | ⛔                  | ⛔              | ⛔                | ⛔                | ⛔           | ⛔            | ⛔                  | ⛔                    | ⛔                | ⛔                 | ✅ Best-in-class    | ⛔                  |
| Team collaboration / shared library      | Partial          | ⛔              | ✅              | ✅ (internal)      | ✅               | ✅ (venue-side) | ⛔              | ⛔              | Partial (RFP teams) | ⛔ (agency-owned)    | ⛔              | Partial               | ✅                | ✅                  | ⛔              | ✅ (files only)   | ✅ (manual)       | Partial      | ⛔            | ⛔                  | ✅ (event-scoped)     | ⛔                | ⛔                 | ⛔                  | ✅                  |
| Multi-tenant SaaS                        | ✅               | ✅              | ✅              | ✅                 | ✅               | ✅              | ✅              | ✅              | ✅                  | Partial (SW add-on)  | ✅              | ✅                    | ✅                | ✅                  | ✅              | ✅                | ✅                | ✅           | ✅            | ✅                  | ✅                    | ⛔ (early-stage)  | ✅ (API)           | ⛔ (open source)    | ✅                  |
| Venue-specific schema                    | ⛔               | ✅ (operations) | ✅ (operations) | ✅ (operations)    | ⛔               | ✅ (operations) | ⛔              | ⛔              | ✅ (RFP fields)     | ✅ (agency intel)    | ✅ (operations) | ⛔                    | ⛔                | ⛔                  | ⛔              | ⛔                | Partial (manual)  | Partial      | ⛔            | ⛔                  | ⛔                    | ⛔                | ⛔                 | ⛔                  | ✅ (intelligence)   |
| SMB-friendly pricing                     | ⛔               | Partial         | ⛔              | ✅ (no cost)       | ✅               | ✅              | ✅ (free)       | ✅ (free)       | ✅ (free tier)      | ⛔ (agency fees)     | Partial         | ✅ (free tier)        | ⛔                | ⛔                  | ✅              | ✅ (free/bundled) | ✅ (free tier)    | ✅ (free)    | ✅ (free)     | ✅ (free tier)      | ✅ (free tier)        | ✅ (free tier)    | ✅ (free tier)     | ✅ (open source)    | ✅                  |
...
**Docs:** [What is StashRoom?](../../README.md) · [Business Proposal](proposal.md) · [Competitive Landscape](comparison.md) · [Intelligence Layer](../../platform/intelligence.md) · [Architecture](../../platform/architecture.md)

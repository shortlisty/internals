...
- Stadium, arena, and convention centre venues — too large, operator-side tools already cover them, not OiQb's ICP
...
- Capacity range: 30–300 guests — the core OiQb ICP brief range
...
5. Create a venue card in OiQb with name, address, and source URL
...
**Docs:** [What is OiQb?](../../README.md) · [Business Proposal](proposal.md) · [Market Structure](../market.md) · [Vision](../../roadmap/vision.md)

...
**Event manager / agency** — the professional who finds the right venue for a client, briefs it, and coordinates the high-level plan. They work across many venues and many clients. Their job is to know the landscape of available venues and match briefs to the right space. This is the role StashRoom Intelligence is built for.
...
## Where StashRoom sits

StashRoom Intelligence is the tool for the vacant slot: the event manager's venue knowledge base.

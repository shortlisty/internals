...
Business and product documentation for the **Digital Sales Room (DSR) for Events** concept — the direction OiQb is moving toward after the alignment discussions of July 2026.
...
**Docs:** [What is OiQb?](../../README.md) · [Market Structure](../market.md) · [Personal Venue Catalog](../Personal_Venue_Catalog/product.md) · [Architecture](../../platform/architecture.md) · [Vision](../../roadmap/vision.md)

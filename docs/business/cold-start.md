...
- Stadium, arena, and convention centre venues — too large, operator-side tools already cover them, not iQ BENE's ICP
...
- Capacity range: 30–300 guests — the core iQ BENE ICP brief range
...
5. Create a venue card in iQ BENE with name, address, and source URL
...
**Docs:** [What is iQ BENE?](../README.md) · [Business Proposal](proposal.md) · [Market Structure](market.md) · [Vision](../roadmap/vision.md)
